...
const AthleteLoginScreen = ({ navigation }: any) => {
  ...
  const onSubmit = async (data: FormData) => {
    setLoading(true);
    try {
      await loginUser(data.idType, data.idNumber, data.password, 'athlete');
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.flex}>
        <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
          <View style={styles.header}>
            <View style={styles.rolePill}><Text style={styles.roleText}>Logging in as Athlete</Text></View>
            <Text style={styles.title}>Welcome Back</Text>
            <Text style={styles.subtitle}>Sign in to track your performance and progress.</Text>
