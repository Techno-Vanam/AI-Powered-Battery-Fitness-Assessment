...
const CoachOtpVerifyScreen: React.FC<CoachOtpVerifyScreenProps> = ({ navigation, route }) => {
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.resendContainer}>
            ...
            <TouchableOpacity 
              ...
              disabled={timer > 0}
            >
              <RefreshCw size={16} color={timer > 0 ? '#94A3B8' : '#059669'} style={styles.resendIcon} />
...
const styles = StyleSheet.create({
  ...
  otpInputFilled: { borderColor: '#059669', backgroundColor: '#ECFDF5' },
  button: { backgroundColor: '#059669', borderRadius: 12, height: 56, justifyContent: 'center', alignItems: 'center', marginBottom: 24 },
  ...
  resendText: { fontSize: 16, color: '#059669', fontWeight: '600' },
