...
import { CreditCard, Lock, Eye, EyeOff, ChevronDown, WifiOff, ClipboardList } from 'lucide-react-native';
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
          <View style={styles.header}>
            <View style={styles.iconContainer}>
              <ClipboardList size={40} color="#059669" />
            </View>
          ...
          <View style={styles.formContainer}>
            ...
            <View style={styles.footer}>
              <Text style={styles.footerText}>New coach? </Text>
...
const styles = StyleSheet.create({
  ...
  forgotPasswordText: { color: '#059669', fontWeight: '600', fontSize: 14 },
  button: {
