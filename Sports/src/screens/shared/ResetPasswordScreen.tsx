...
const ResetPasswordScreen: React.FC<ResetPasswordScreenProps> = ({ navigation }) => {
  ...
  const handleSubmit = () => {
    if (isValid) {
      // Simulate saving new password locally
      setIsSuccess(true);
    }
  };

  const handleContinue = () => {
    // Return to main select mode after reset
    ...
    return (
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.successContainer}>
          ...
          <Text style={styles.successSubtitle}>Your new password has been saved successfully.</Text>
      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Enter a new strong password with at least 8 characters, including a letter and a number.</Text>
          </View>
          ...
          <View style={styles.formContainer}>
            ...
            <TouchableOpacity 
              ...
              disabled={!isValid}
            >
              <Text style={styles.buttonText}>Reset Password & Continue</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
