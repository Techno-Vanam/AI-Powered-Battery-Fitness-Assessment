...
import SitAndReachCameraScreen from '../screens/SitAndReach/SitAndReachCameraScreen';
import TestVisionCameraScreen from '../screens/TestVisionCameraScreen';
...
export type RootStackParamList = {
  ...
  SitAndReachCamera: { athleteId: number; athleteName: string };
  SitAndReachResult: { athleteId: number; athleteName: string; trials: [number, number, number] };
  TestVisionCamera: undefined;
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Stack.Screen name="SitAndReachCamera" component={SitAndReachCameraScreen} />
        <Stack.Screen
          name="SitAndReachResult"
          component={require('../screens/SitAndReach/SitAndReachResultScreen').default}
        />
        <Stack.Screen name="TestVisionCamera" component={TestVisionCameraScreen} />
